...
export const CLIENTS = [
  { name: 'Red Bull', logo: 'https://upload.wikimedia.org/wikipedia/en/thumb/f/f5/Red_Bull_Racing_logo.svg/512px-Red_Bull_Racing_logo.svg.png' },
  { name: 'Porsche', logo: 'https://upload.wikimedia.org/wikipedia/en/thumb/d/df/Porsche_logo.svg/512px-Porsche_logo.svg.png' },
  { name: 'Nike', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a6/Logo_NIKE.svg/512px-Logo_NIKE.svg.png' },
  { name: 'Monster Energy', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Monster_Energy_logo.svg/512px-Monster_Energy_logo.svg.png' },
  { name: 'BMW', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/BMW.svg/512px-BMW.svg.png' }
];
